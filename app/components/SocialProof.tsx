      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <div className="text-muted-foreground">Early Access Signups</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-4xl font-bold text-foreground mb-2">₹12.5L+</div>
            <div className="text-muted-foreground">Money Tracked So Far</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-muted-foreground">Beta User Rating</div>
          </div>
        </div>
